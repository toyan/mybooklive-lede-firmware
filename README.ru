...
Прошивка предназначена для установки на однодисковый сетевой накопитель Western Digital 'MyBook Live'.
...
системы командой "adduser <имя>", затем добавить его в пользователи самбы: smbpasswd -a <имя>.
...
v1.01 (2017-04-05)
	...
	* Этот параметр обеспечмвает максимальную совместимость файловой системы с большинством десктоп-компьютeров,
    ...
    - сетевой файл-сервер Samba v3.6.25;
